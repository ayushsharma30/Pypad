...
main_application.title('pypad text editor')
...
## file commands
file.add_command(label='New', accelerator='Ctrl+N', image=new_icon, compound=tk.LEFT, command=new_file)
...
file.add_command(label='Open', accelerator='Ctrl+O', image=open_icon, compound=tk.LEFT, command=open_file)
...
file.add_command(label='Save', accelerator='Ctrl+S', image=save_icon, compound=tk.LEFT, command=save_file)
...
file.add_command(label='Save As', accelerator='Ctrl+Alt+S', image=save_as_icon, compound=tk.LEFT, command=save_as)
...
def exit_func(event=None):
    ...
    try:
        ...
        return 
file.add_command(label='Exit', accelerator='Ctrl+Q', image=exit_icon, compound=tk.LEFT, command=exit_func)
...
edit.add_command(label='Paste', accelerator='Ctrl+V', image=paste_icon, compound=tk.LEFT, command=lambda:text_editor.event_generate("<Control v>"))
